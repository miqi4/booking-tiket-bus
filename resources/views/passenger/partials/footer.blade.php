<footer class="bg-surface-container-lowest mt-auto border-t border-outline-variant">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-lg py-lg px-gutter max-w-container-max mx-auto">
        <div><span class="text-h3 font-h3 text-primary">PO. Akas</span><p class="font-caption text-caption text-on-surface-variant mt-xs">Booking tiket bus online yang rapi, cepat, dan mudah dipantau.</p></div>
